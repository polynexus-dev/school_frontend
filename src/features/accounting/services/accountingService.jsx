...
const accountingService = {
  getLedgerAccounts,
  getAccounts: getLedgerAccounts,
  createLedgerAccount,
  createAccount: createLedgerAccount,
  updateLedgerAccount,
  updateAccount: updateLedgerAccount,
  deleteLedgerAccount,
  deleteAccount: deleteLedgerAccount,
  getPaymentMethodMappings,
  createPaymentMethodMapping,
  updatePaymentMethodMapping,
  upsertPaymentMethodMapping: createPaymentMethodMapping,
  getJournalEntries,
  createJournalEntry,
  postJournalEntry,
  reverseJournalEntry,
  ...
  issueUtilizationCertificate,
  getStatutoryChallans,
  createStatutoryChallan,
  getProvisionSchedules,
  createProvisionSchedule,
  releaseProvisionSchedule,
};
